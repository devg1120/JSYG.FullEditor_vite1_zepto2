...
/*
    set_text_decoration(name) {
          console.log("set_text_decoration", name);
	  let list = this.getText_decoration()
          if ( list.includes(name) ) {
             let new_list = list.concat(" ", name);
	     this.setText_decoration(new_list)
	  }
          console.log("set", list, new_list);
    }
    unset_text_decoration(name) {
          console.log("unset_text_decoration", name);
	  let list = this.getText_decoration()
          if ( list.includes(name) ) {
             let new_list = list.replace(name, "");
	     this.setText_decoration(new_list)
	  }
          console.log("unset", list, new_list);
    }
    */
      ...
      switch (key) {
        ...
        case "Tab":
		  ...
		  console.log("apply");
            ...
            //let new_param = this.textEditor.getText_decoration();
            let new_param = "";
...
*/
		  ...
		  console.log("under")
	       ...
	       if (this.underLineToggle.classList.contains("active")) {
                   //this.textEditor.set_text_decoration("underline");
                   this.text_decoration_underLine = true;

	       } else {
                   //this.textEditor.unset_text_decoration("underline");
                   this.text_decoration_underLine = false;
	       }
          });
		  ...
		  console.log("over")
	       ...
	       if (this.overLineToggle.classList.contains("active")) {
                   //this.textEditor.set_text_decoration("overline");
		  this.text_decoration_overLine = true;
	       } else {
                   //this.textEditor.unset_text_decoration("overline");
		  this.text_decoration_overLine = false;
	       }
          });
		  ...
		  console.log("strik")
	       ...
	       if (this.striketHroughToggle.classList.contains("active")) {
                   //this.textEditor.set_text_decoration("line-through");
	           this.text_decoration_striketHrough = true;	   
	       } else {
                   //this.textEditor.unset_text_decoration("line-through");
		   this.text_decoration_striketHrough = false;
	       }
          });
