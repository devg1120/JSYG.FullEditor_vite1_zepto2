  ...
  */
    ...
    JSYG.prototype.getDim = function(type) {
        ...
        if (isWindow(node)) {
            ...
            x = boundingRect.left + jWin[0].scrollLeft - document.documentElement.clientLeft;  //GUSA
            //y = boundingRect.top + jWin.scrollTop() - document.documentElement.clientTop;    //GUSA
            y = boundingRect.top + jWin[0].scrollTop - document.documentElement.clientTop;     //GUSA
