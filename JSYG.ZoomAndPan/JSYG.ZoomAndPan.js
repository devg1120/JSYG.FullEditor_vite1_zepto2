...
*/
	...
	console.log(exclude.list, innerFrame);
        //jSVG[0].appendChild(exclude.list);
        jSVG[0].appendChild(innerFrame[0]);
...
*/
    ...
    ZoomAndPan.prototype.transform = function(mtx,callback) {
        ...
        scrollLeft = outerFrame && outerFrame[0].scrollLeft,  //GUSA
        ...
        if (!hidden) {
            ...
            outerFrame[0].scrollLeft= Math.round(transf.translateX - translX) ;  //GUSA
